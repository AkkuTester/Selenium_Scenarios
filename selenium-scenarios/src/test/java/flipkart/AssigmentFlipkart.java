...
public class AssigmentFlipkart {
		...
		public void TestFlipkartSearch() {
			...
			WebElement txtbx_search_result_text = driver.findElement(By.xpath("//span[contains(text(),'Showing 1 – 24 of')]]"));
			...
			Reporter.log("Product Name and price fetched from UI and saved in HashMap as:" + "<br>",true);
